...
public class Contact
{
	...
	private void initialize()
	{
		...
		Layout contact = new Layout(panel_north, panel_south, frame);
			contact.Header(true);
	...
	private void ChangeContact(String mode) 
	{
		...
		Layout adding = new Layout(dgFrame);
		adding.Header(false);
	...
	private void fileWriter() 
	{
		...
		if(directory.isDirectory())
		{
			try 
			{
				File myNewFile = new File(directory, tName.getText()+".txt");
	...
	private void tools_alpha_add()
	{
		...
		lblAdd.setIcon(new ImageIcon(Contact.class.getResource("/img/add.PNG")));
		...
		lblContact.setIcon(new ImageIcon(Contact.class.getResource("/img/contact.PNG")));
		
		// FAVORIS CONTACT
		lblFavoris = new JLabel("");
		panel_tools.add(lblFavoris);		
		lblFavoris.setHorizontalAlignment(SwingConstants.CENTER);
		lblFavoris.setIcon(new ImageIcon(Contact.class.getResource("/img/favori.PNG")));
